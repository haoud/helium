...
/// Set up the system call mechanism. This function should be called once
/// during the kernel initialization.
///
/// # Safety
/// This function is unsafe because it assume that the `syscall_enter`
/// function exists in the kernel code, and is correctly set up to handle
/// system calls.
pub unsafe fn setup() {
