...
pub static LIMINE_MEMMAP: limine::request::MemoryMapRequest = limine::request::MemoryMapRequest::new();
...
pub static LIMINE_FRAMEBUFFER: limine::request::FramebufferRequest = limine::request::FramebufferRequest::new();
